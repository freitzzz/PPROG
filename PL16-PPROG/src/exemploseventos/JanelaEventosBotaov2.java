 ...
 */
public class JanelaEventosBotaov2 extends JFrame {
    
    /**
     * Trata o evento Action dos botões de comando.
     */
    ...
    private class TrataEvento implements ActionListener {
        ...
        /**
         * Método de evento do tipo Action gerado quando um botão de comando é
         * acionado. Este método mostra uma mensagem ao utilizador informando o
         * botão acionado.
         *
        ...
        public void actionPerformed(ActionEvent e) {
            JOptionPane.showMessageDialog(JanelaEventosBotaov2.this,
    ...
    public static void main(String[] args) {
        ...
        JanelaEventosBotaov2 janela = new JanelaEventosBotaov2();
